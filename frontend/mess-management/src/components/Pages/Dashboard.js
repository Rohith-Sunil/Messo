    ...
    <div className="flex flex-col h-screen lg:overflow-hidden">
      ...
      <div className="bg-neutral-100 flex flex-col items-center justify-center ">
        <div className="flex-1 lg:overflow-hidden p-2 gap-4 flex-col">
          ...
          <div className="flex lg:flex-row lg:overflow-hidden p-2 gap-4 flex-col mb-12 lg:mb-0">
            ...
            <div className="lg:w-1/3 w-full flex flex-col gap-4 mt-4 max-h-[39rem] mb-4 lg:mb-0">
              <div className="bg-white shadow-md rounded-lg p-4 flex-none ">
                <PopularDays />
              </div>
              <div className="bg-white shadow-md rounded-lg p-4 flex-1 overflow-y-auto max-h-[23rem] mb:4">
                <LatestAnnouncement />
              </div>
            </div>
          </div>
